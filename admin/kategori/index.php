                                                ...
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-success btn-outline" data-toggle="modal" data-target=".kategori-show-<?php echo $data['id']; ?>">Show</button> |
                                                            <button type="button" class="btn btn-sm btn-warning btn-outline" data-toggle="modal" data-target=".kategori-<?php echo $data['id']; ?>">Edit</button>
                                                        </td>
                                                    </tr>
